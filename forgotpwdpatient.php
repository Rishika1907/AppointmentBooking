...
// Check whether the email entered is registered and data entered is proper
   $result = mysqli_query($con,"SELECT * FROM patientregistration WHERE email = '$email' and phone ='$phone'");
   $row = mysqli_num_rows($result);
   if($row == 0){
    $log_err=true;
      }
    else{
        header("location:resetpwdpatient.php?success");       
    }
...
<body>
    ...
    <div class="container divtag">
        <div>
            <img src="image\th.jpg" alt="..." class="user">
       </div>
       <form action="forgotpwdpatient.php" method="post">
